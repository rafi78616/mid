                    ...
                    <MDBCard className="shadow-0 border mb-4">
                      <MDBCardBody>
                        <MDBRow>
                          <MDBCol md="2">
                            <MDBCardImage
                              src= {require("./assets/images/painting2.jpg")}
                              fluid
                              alt="Phone"
                            />
                          </MDBCol>
                          ...
                          >
                            <p className="text-muted mb-0">Paintings</p>
                          </MDBCol>
                          <MDBCol
                            md="2"
                            className="text-center d-flex justify-content-center align-items-center"
                          ...
                          <MDBCol
                            ...
                            className="text-center d-flex justify-content-center align-items-center"
                          >
                            <p className="text-muted mb-0 small">499rs</p>
                          </MDBCol>
                        </MDBRow>
                        <hr
                          className="mb-4"
                    ...
                    <MDBCard className="shadow-0 border mb-4">
                      <MDBCardBody>
                        <MDBRow>
                          <MDBCol md="2">
                            <MDBCardImage
                              src={require("./assets/images/sketching2.jpg")}
                              fluid
                              alt="Phone"
                            />
                          </MDBCol>
                          <MDBCol
                            ...
                            className="text-center d-flex justify-content-center align-items-center"
                          >
                            <p className="text-muted mb-0">Sketching</p>
                          </MDBCol>
                          <MDBCol
                            md="2"
                            className="text-center d-flex justify-content-center align-items-center"
                          ...
                          <MDBCol
                            ...
                            className="text-center d-flex justify-content-center align-items-center"
                          >
                            <p className="text-muted mb-0 small">399rs</p>
                          </MDBCol>
                        </MDBRow>
                        <hr
                          className="mb-4"
